...
import (
	...
	"github.com/rosas/onex/internal/onexctl/cmd/color"
	"github.com/rosas/onex/internal/onexctl/cmd/completion"
	"github.com/rosas/onex/internal/onexctl/cmd/info"
	"github.com/rosas/onex/internal/onexctl/cmd/jwt"
	"github.com/rosas/onex/internal/onexctl/cmd/new"
	"github.com/rosas/onex/internal/onexctl/cmd/options"
	cmdutil "github.com/rosas/onex/internal/onexctl/cmd/util"
	"github.com/rosas/onex/internal/onexctl/cmd/validate"
	"github.com/rosas/onex/internal/onexctl/cmd/version"

	// "github.com/rosas/onex/internal/onexctl/plugin".
	"github.com/rosas/onex/internal/onexctl/cmd/minerset"
	clioptions "github.com/rosas/onex/internal/onexctl/util/options"
	"github.com/rosas/onex/internal/onexctl/util/templates"
	"github.com/rosas/onex/internal/onexctl/util/term"
	"github.com/rosas/onex/pkg/cli/genericclioptions"
)
...
func NewOneXCtlCommand(in io.Reader, out, err io.Writer) *cobra.Command {
	...
	cmds := &cobra.Command{
		...
		Find more information at:
			https://github.com/rosas/onex/blob/master/docs/guide/en-US/cmd/onexctl/onexctl.md`),
		Run: runHelp,

...
//go:generate mockgen -destination mock_cronjob.go -package cronjob github.com/rosas/onex/internal/nightwatch/biz/cronjob CronJobBiz
...
import (
	...
	"github.com/rosas/onex/internal/nightwatch/conversion"

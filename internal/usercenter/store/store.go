...
//go:generate mockgen -self_package github.com/rosas/onex/internal/usercenter/store -destination mock_store.go -package store github.com/rosas/onex/internal/usercenter/store IStore,SecretStore,UserStore
